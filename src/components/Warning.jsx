...
export default function Warning({ children }) {
  return (
    <div className="flex-center focus-primary transition-animation min-h-0 shrink-0 scale-100 gap-x-1.5 p-2 text-xs opacity-100 h-fit w-full rounded-xl bg-red-500/70 text-white dark:text-dark-theme-text">
